...
namespace EasyMicroservices.Utilities.Tests.Text
{
    public class TextExtensionsTest
    {
        ...
        [InlineData("Hello World", "e", 1, new string[] { "H" })]
        [InlineData("Hello World", "o", 1, new string[] { "Hell" })]
        [InlineData("Hello World", "e", 2, new string[] { "H", "llo World" })]
        [InlineData("Hello World", "o", 2, new string[] { "Hell", " W" })]
        ...
        [InlineData("Hello World", "a", 2, new string[] { "Hello World" })]
        [InlineData("Hello WorldWorld ", "Wo", 2, new string[] { "Hello ", "rld" })]
